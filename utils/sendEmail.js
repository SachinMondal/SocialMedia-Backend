...
// Remove or rename the conflicting hashString import
const { hashString: hashStringFromIndex } = require("./index.js");
...
`,
    ...
    try {
        const hashedToken = await hashStringFromIndex(token);
